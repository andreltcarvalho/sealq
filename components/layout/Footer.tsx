      ...
      <Container className="grid gap-8 py-10 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-3 max-w-md text-sm leading-6 text-[#566247]">
            ...
            visual inspirada nas culturas de cana-de-acucar, citros e milho.
          </p>
        </div>

        <div>
          <p className="text-sm font-semibold text-[#16351f]">Navegacao</p>
        ...
        <div>
          <p className="text-sm font-semibold text-[#16351f]">Organizacao</p>
