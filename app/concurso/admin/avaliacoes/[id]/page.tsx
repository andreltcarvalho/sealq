...
import { Accordion } from "@/components/concurso/ui/Accordion";
import { ConflictDetails, Review } from "@/types/concurso";
import {
  Container,
  Content,
  Header,
...
export default function ConcursoAdminEvaluationPage() {
          ...
          <Card>
            ...
            {data.reviews.map((review: Review, index: number) => (
              ...
              >
                ...
                <CommentText>&ldquo;{review.comentario}&rdquo;</CommentText>
              </Accordion>
            ))}
          </Card>
        </GridContainer>
