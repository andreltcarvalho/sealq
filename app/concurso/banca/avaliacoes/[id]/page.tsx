...
import { calculateWeightedGrade } from "@/lib/concurso/utils/scoreCalculator";
...
export default function ConcursoJuryAssessmentPage() {
      ...
      <S.Content>
        <S.Header>
          ...
          <Button
            ...
            onClick={() => router.push("/concurso/banca")}
          >
