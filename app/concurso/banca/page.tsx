...
interface JuryProject {
  ...
  projectTitle: string;
  date: string;
  myVoteStatus: "pendente" | "revisao" | "avaliado";
}

const MOCK_PROJECTS: JuryProject[] = [
  {
    id: "1",
    protocol: "REQ-001",
...
export default function ConcursoJuryPage() {
  ...
  const handleExecuteAction = useCallback(
    (id: string) => {
      router.push(`/concurso/banca/avaliacoes/${id}`);
    },
    [router],
  );
    ...
    <Container>
      <Content>
        ...
        <Header>
          ...
          <Button variant="secondary" onClick={() => router.push("/concurso/login")}>
            → Sair
          </Button>
        </Header>
